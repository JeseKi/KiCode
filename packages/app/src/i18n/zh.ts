...
export const dict = {
  ...
  "dialog.provider.opencode.note": "使用 KiCode Zen 或 API 密钥连接",
  ...
  "dialog.model.unpaid.freeModels.title": "KiCode 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 KiCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "KiCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 KiCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 KiCode 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 kicode.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 KiCode 服务器。",
  ...
  "toast.update.description": "KiCode 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 KiCode 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (kicode.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: KiCode 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "KiCode 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 KiCode 服务器。",
  ...
  "settings.general.row.language.description": "更改 KiCode 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 KiCode 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 KiCode 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 KiCode 的主题。",
  ...
  "settings.updates.row.startup.description": "在 KiCode 启动时自动检查更新",
  ...
  "settings.general.row.logout.title": "登出",
  "settings.general.row.logout.description": "清除本地的登录信息，并返回登录页面。",
  "settings.general.row.logout.working": "登出中...",
