export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by KiCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in KiCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "KiCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in KiCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in KiCode.",
  ...
  "dialog.plugins.empty": "Plugins configured in kicode.json",
  ...
  "dialog.server.description": "Switch which KiCode server this app connects to.",
  ...
  "toast.update.description": "A new version of KiCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the KiCode team",
  ...
  "error.chain.checkConfig": "Check your config (kicode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, KiCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "KiCode includes free models so you can start immediately.",
  ...
  "app.name.desktop": "KiCode Desktop",
  ...
  "settings.desktop.wsl.description": "Run the KiCode server inside WSL on Windows.",
  ...
  "settings.general.row.logout.title": "Log out",
  "settings.general.row.logout.description": "Clear the local auth.json session and return to the sign-in screen.",
  "settings.general.row.logout.working": "Logging out...",

  "settings.general.row.language.title": "Language",
  "settings.general.row.language.description": "Change the display language for KiCode",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how KiCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether KiCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how KiCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when KiCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of KiCode.",
