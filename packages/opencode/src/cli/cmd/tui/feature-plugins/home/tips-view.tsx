...
const TIPS = [
  ...
  "Open {highlight}/models{/highlight} and press {highlight}Ctrl+F{/highlight} to favorite the current model",
  ...
  "Open {highlight}/models{/highlight} and start typing to fuzzy search across available models",
