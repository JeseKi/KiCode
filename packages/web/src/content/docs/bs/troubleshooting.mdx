...
KiCode Desktop pokreće lokalni OpenCode server (`opencode-cli` sidecar) u pozadini. Većina problema je uzrokovana nedostatkom dodatka, oštećenom keš memorijom ili lošim postavkama servera.
...
1. Potpuno zatvorite KiCode Desktop.
...
3. Ponovo pokrenite KiCode Desktop.

---

### Rješavanje problema sa vezom na serveru

KiCode Desktop može ili pokrenuti svoj lokalni server (podrazumevano) ili se povezati na URL servera koji ste konfigurisali.
...
Na Windows-u, KiCode Desktop zahtijeva Microsoft Edge **WebView2 Runtime**. Ako se aplikacija otvori u praznom prozoru ili se ne pokrene, instalirajte/ažurirajte WebView2 i pokušajte ponovo.
...
KiCode Desktop prikazuje sistemska obavještenja samo kada:
...
1. Zatvorite KiCode Desktop.
2. Pronađite i izbrišite ove datoteke (oni žive u direktoriju podataka KiCode Desktop aplikacije):
